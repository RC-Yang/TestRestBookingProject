                        ...
                        <div class="row">
                            <form id="reg" class="needs-validation" novalidate>
                                <div class="d-flex flex-row justify-content-evenly align-items-center my-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="userType" id="userType" checked>
                                        <label class="form-check-label userType" for="userType">
                                          餐廳端
                                        </label>
                                    </div>
                                ...
                                <div class="mb-5">
                                    <label for="inputCheckedPassword1" class="form-label">Confirm Password</label>
                                    <input type="password" class="form-control" id="inputCheckedPassword" name="inputCheckedPassword" required>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary" onclick="checkRegForm();">提交</button>
...
<script>
    function checkRegForm(){
    	...
    	if($("#reg #inputEmail").val()==''||$("#reg #inputEmail").val()==null){
    	...
    	if($("#reg #inputPassword1").val()==''||$("#reg #inputPassword1").val()==null){
    	...
    	if($("#reg #inputPassword1").val()==''||$("#reg #inputPassword1").val()==null){
			...
			$("#inputCheckedPassword").css("border-color","red");
    	}
    	else{
    		$(".valid-CheckedPassword").css("display","block");
    		$(".valid-CheckedPassword").css("color","green");
    		$("#inputCheckedPassword").css("border-color","green");
    	}
    }
